from interface import execute_query, to_vote, tally_votes, print_votes, error
import random
...
def voting_simulation():
    ...
    tally_centers = execute_query("SELECT * FROM tally_centers")
    candidates = execute_query("SELECT * FROM candidates")
